...
CREATE OR REPLACE TABLE `tmp_dm_gift_product_variants` (
...
CREATE INDEX ix_tmp_dm_gift_product_variants_product_id ON tmp_dm_gift_product_variants(product_id);
CREATE INDEX ix_tmp_dm_gift_product_variants_designId ON tmp_dm_gift_product_variants(designId);

-- DROP TABLE tmp_dm_gift_product_variants
-- DELETE FROM tmp_dm_gift_product_variants
-- SELECT * from tmp_dm_gift_product_variants
