INSERT INTO "PROD"."WORKSPACE_GREETZ_HISTORY_MIGRATION"."PRODUCT_VARIANTS_DETAILED" 
...
pl.productid	AS	GREETZ_PRODUCT_ID	,
pl.carddefinitionid	AS	GREETZ_CARDDEFINITION_ID,

concat( upper(pl.Attribute_Size), 
		case pl.Attribute_Shape when 'square' then 'SQUARE' else '' end, 
		'CARD')	AS	CARD_VARIANT
