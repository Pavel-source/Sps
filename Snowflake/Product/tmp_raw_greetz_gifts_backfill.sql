CREATE OR REPLACE TABLE "PROD"."WORKSPACE_GREETZ_HISTORY_MIGRATION"."PRODUCT_VARIANTS_DETAILED"  AS (
...
AS	SEARCH_KEYWORDS	,
		...
		'Greetz'	AS	BRAND_DESCRIPTION	,
		 ...
		 p.designId		AS	GREETZ_CARDDEFINITION_ID,
		 NULL	AS CARD_VARIANT
