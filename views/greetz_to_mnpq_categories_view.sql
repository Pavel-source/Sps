...
-- Brand/Designer, Tony's --> Brands, Tonys Chocoloney
UNION ALL SELECT 1143735281, 'tonys-chocoloney', 'Brands', 'chocolate'
-- Brand/Designer, Tubes --> NULL, NULL
...
-- Brand/Designer, Tony's --> Brands, Tonys Chocoloney
UNION ALL SELECT 1143735281, 'tonys-chocoloney', 'Brands', 'flower'
...
-- Brand/Designer, Greetz --> NULL, NULL
UNION ALL SELECT 726316072, NULL, NULL, 'personalised-mug'
-- Color, Black --> Colour, Black
...
UNION ALL SELECT 1143728196, 'colour-white', 'Colour', 'personalised-mug'
-- Color, Silver --> Colour, White
UNION ALL SELECT 1143728196, 'colour-white', 'Colour', 'personalised-mug'
-- Color, White --> Colour, White
...
-- Occasion, Love --> Occasion, Missing You
UNION ALL SELECT 1143727832, 'missing-you', 'Occasion', 'personalised-mug'
-- Occasion, Mothersday --> Occasion, Mothers Day
...
-- Occasion, Sinterklaas --> Occasion, Other
UNION ALL SELECT 726330911, 'occasion-other', 'Occasion', 'personalised-mug'
-- Occasion, Thank you --> Occasion, Thank You
...
UNION ALL SELECT 1143730239, 'mugs', 'Home & Garden', 'personalised-mug'
-- Target Group, Boy --> Who's it for?, For Boys
UNION ALL SELECT 886506339, 'for-boys', 'Whos it for?', 'personalised-mug'
-- Target Group, Girl --> Who's it for?, For Girls
UNION ALL SELECT 886507052, 'for-girls', 'Whos it for?', 'personalised-mug'
-- Target Group, Men --> Who's it for?, For Him
UNION ALL SELECT 1143750956, 'for-him', 'Whos it for?', 'personalised-mug'
-- Target Group, Women --> Who's it for?, For Her
UNION ALL SELECT 1143750947, 'for-her', 'Whos it for?', 'personalised-mug'
-- Target Group, Zakelijk1 (cards missions) --> Who's it For?, Other
UNION ALL SELECT 1143732725, 'newia-gift-experiences-whos-it-for-other', 'Whos it For?', 'personalised-mug'
-- Type, Photo and text gifts --> NewIa, Personalised Gifts
