...
AS
(
SELECT	0	 AS productId,	3000096131 AS designId
UNION ALL SELECT	0	,	3000096141
UNION ALL SELECT	0	,	3000096146
UNION ALL SELECT	0	,	3000096136
UNION ALL SELECT	0	,	3000096151
UNION ALL SELECT	0	,	3000096676
UNION ALL SELECT	0	,	3000096681
UNION ALL SELECT	0	,	3000096691
UNION ALL SELECT	0	,	3000096716
UNION ALL SELECT	0	,	3000096761
UNION ALL SELECT	0	,	3000096756
UNION ALL SELECT	0	,	3000097051
UNION ALL SELECT	0	,	3000097031
UNION ALL SELECT	0	,	3000097046
UNION ALL SELECT	0	,	3000097061
UNION ALL SELECT	0	,	3000097066
UNION ALL SELECT	0	,	3000097071
UNION ALL SELECT	0	,	3000097076
UNION ALL SELECT	0	,	3000074113
UNION ALL SELECT	0	,	3000078548
UNION ALL SELECT	0	,	3000082063
UNION ALL SELECT	0	,	1142776843
UNION ALL SELECT	0	,	3000078278
UNION ALL SELECT	0	,	3000078203
UNION ALL SELECT	0	,	3000078593
UNION ALL SELECT	0	,	3000074123
UNION ALL SELECT	0	,	3000003853
UNION ALL SELECT	0	,	3000082068
UNION ALL SELECT	0	,	1142776831
UNION ALL SELECT	0	,	3000078653
UNION ALL SELECT	0	,	3000009152
UNION ALL SELECT	0	,	3000078638
UNION ALL SELECT	0	,	3000065708
UNION ALL SELECT	0	,	1142780117
UNION ALL SELECT	0	,	1142753516
UNION ALL SELECT	0	,	3000074863
UNION ALL SELECT	0	,	3000006236
UNION ALL SELECT	0	,	3000078208
UNION ALL SELECT	0	,	3000078473
UNION ALL SELECT	0	,	3000078553
UNION ALL SELECT	0	,	3000078598
UNION ALL SELECT	0	,	3000074823
UNION ALL SELECT	0	,	1142755301
UNION ALL SELECT	0	,	3000074843
UNION ALL SELECT	0	,	3000082088
UNION ALL SELECT	1042936279	,	621178069
UNION ALL SELECT	0	,	3000074153
UNION ALL SELECT	0	,	3000008468
UNION ALL SELECT	0	,	3000078158
UNION ALL SELECT	0	,	3000078283
UNION ALL SELECT	0	,	3000074108
UNION ALL SELECT	0	,	3000069103
UNION ALL SELECT	0	,	3000082033
UNION ALL SELECT	0	,	3000001772
UNION ALL SELECT	0	,	3000069118
UNION ALL SELECT	0	,	3000078668
UNION ALL SELECT	0	,	3000078563
UNION ALL SELECT	0	,	3000078293
UNION ALL SELECT	0	,	3000078568
UNION ALL SELECT	0	,	1142777875
UNION ALL SELECT	0	,	3000078488
UNION ALL SELECT	0	,	3000074158
UNION ALL SELECT	0	,	3000082093
UNION ALL SELECT	0	,	3000078533
UNION ALL SELECT	0	,	3000078503
UNION ALL SELECT	0	,	3000012497
UNION ALL SELECT	0	,	621181065
UNION ALL SELECT	0	,	3000007265
UNION ALL SELECT	0	,	3000074118
UNION ALL SELECT	0	,	3000069728
UNION ALL SELECT	0	,	3000078298
UNION ALL SELECT	0	,	3000014188
UNION ALL SELECT	0	,	3000074878
UNION ALL SELECT	0	,	3000006674
UNION ALL SELECT	0	,	1142755304
UNION ALL SELECT	0	,	3000074148
UNION ALL SELECT	0	,	3000082058
UNION ALL SELECT	0	,	3000026238
UNION ALL SELECT	0	,	3000006227
UNION ALL SELECT	0	,	3000078288
UNION ALL SELECT	0	,	3000003856
UNION ALL SELECT	0	,	3000082043
UNION ALL SELECT	0	,	3000074893
UNION ALL SELECT	0	,	3000078578
UNION ALL SELECT	0	,	3000078558
UNION ALL SELECT	0	,	3000074093
UNION ALL SELECT	0	,	3000017582
UNION ALL SELECT	0	,	3000006254
UNION ALL SELECT	0	,	3000003973
UNION ALL SELECT	0	,	3000006707
UNION ALL SELECT	0	,	3000078643
UNION ALL SELECT	0	,	3000002809
UNION ALL SELECT	0	,	3000003817
UNION ALL SELECT	0	,	3000074858
UNION ALL SELECT	0	,	3000006245
UNION ALL SELECT	0	,	1142784297
UNION ALL SELECT	0	,	3000078508
UNION ALL SELECT	0	,	3000089006
UNION ALL SELECT	0	,	3000004211
UNION ALL SELECT	0	,	3000009959
UNION ALL SELECT	0	,	3000074868
UNION ALL SELECT	0	,	3000074833
UNION ALL SELECT	0	,	3000012764
UNION ALL SELECT	0	,	1142764963
UNION ALL SELECT	0	,	3000078163
UNION ALL SELECT	0	,	3000074133
UNION ALL SELECT	0	,	3000082078
UNION ALL SELECT	0	,	3000078623
UNION ALL SELECT	0	,	1142784294
UNION ALL SELECT	0	,	3000078673
UNION ALL SELECT	0	,	3000074828
UNION ALL SELECT	0	,	3000074873
UNION ALL SELECT	0	,	3000006713
UNION ALL SELECT	0	,	3000078583
UNION ALL SELECT	0	,	3000014146
UNION ALL SELECT	0	,	1142764960
UNION ALL SELECT	0	,	3000074848
UNION ALL SELECT	0	,	3000065713
UNION ALL SELECT	0	,	3000078608
UNION ALL SELECT	0	,	3000074098
UNION ALL SELECT	0	,	3000002818
UNION ALL SELECT	0	,	3000074103
UNION ALL SELECT	0	,	3000078478
UNION ALL SELECT	0	,	3000078213
UNION ALL SELECT	0	,	3000078303
UNION ALL SELECT	0	,	3000007565
UNION ALL SELECT	0	,	3000074128
UNION ALL SELECT	0	,	3000078493
UNION ALL SELECT	0	,	3000082038
UNION ALL SELECT	0	,	3000003847
UNION ALL SELECT	0	,	3000076413
UNION ALL SELECT	0	,	1142783712
UNION ALL SELECT	0	,	3000006257
UNION ALL SELECT	0	,	3000078573
UNION ALL SELECT	1142799810	,	1142784831
UNION ALL SELECT	0	,	3000013291
UNION ALL SELECT	0	,	3000078663
UNION ALL SELECT	0	,	3000002402
UNION ALL SELECT	0	,	1142761746
UNION ALL SELECT	0	,	3000009161
UNION ALL SELECT	0	,	3000014167
UNION ALL SELECT	0	,	3000014173
UNION ALL SELECT	0	,	3000082083
UNION ALL SELECT	0	,	3000069113
UNION ALL SELECT	0	,	3000089071
UNION ALL SELECT	0	,	3000004150
UNION ALL SELECT	0	,	3000078658
UNION ALL SELECT	0	,	3000078168
UNION ALL SELECT	0	,	3000078513
UNION ALL SELECT	0	,	3000003904
UNION ALL SELECT	0	,	3000078678
UNION ALL SELECT	0	,	3000013093
UNION ALL SELECT	0	,	3000089076
UNION ALL SELECT	0	,	3000008801
UNION ALL SELECT	0	,	3000074163
UNION ALL SELECT	0	,	3000078538
UNION ALL SELECT	0	,	3000078613
UNION ALL SELECT	0	,	3000007487
UNION ALL SELECT	0	,	3000013297
UNION ALL SELECT	0	,	3000089011
UNION ALL SELECT	0	,	3000003850
UNION ALL SELECT	0	,	3000006248
UNION ALL SELECT	0	,	3000004096
UNION ALL SELECT	0	,	3000003934
UNION ALL SELECT	0	,	3000003880
UNION ALL SELECT	0	,	3000074138
UNION ALL SELECT	0	,	3000004208
UNION ALL SELECT	0	,	3000078483
UNION ALL SELECT	0	,	3000078648
UNION ALL SELECT	0	,	3000089001
UNION ALL SELECT	0	,	3000078628
UNION ALL SELECT	0	,	3000078543
UNION ALL SELECT	1142808803	,	3000006956
UNION ALL SELECT	0	,	3000074853
UNION ALL SELECT	0	,	3000082073
UNION ALL SELECT	0	,	1142765272
UNION ALL SELECT	0	,	3000007490
UNION ALL SELECT	0	,	3000012767
UNION ALL SELECT	0	,	3000016175
UNION ALL SELECT	0	,	3000007556
UNION ALL SELECT	0	,	1142785533
UNION ALL SELECT	0	,	1142785536
UNION ALL SELECT	0	,	3000002408
UNION ALL SELECT	0	,	3000007568
UNION ALL SELECT	0	,	3000078498
UNION ALL SELECT	0	,	3000078633
UNION ALL SELECT	1142808803	,	3000006950
UNION ALL SELECT	1142808803	,	3000012524
UNION ALL SELECT	0	,	3000016049
UNION ALL SELECT	0	,	3000074888
UNION ALL SELECT	0	,	3000012889
UNION ALL SELECT	0	,	3000069288
UNION ALL SELECT	0	,	3000006230
UNION ALL SELECT	0	,	3000007277
UNION ALL SELECT	0	,	3000078588
UNION ALL SELECT	0	,	3000014140
UNION ALL SELECT	0	,	3000082053
UNION ALL SELECT	0	,	1142748697
UNION ALL SELECT	0	,	3000013084
UNION ALL SELECT	0	,	3000013288
UNION ALL SELECT	0	,	3000088996
UNION ALL SELECT	0	,	3000017585
UNION ALL SELECT	0	,	3000008804
UNION ALL SELECT	0	,	3000017588
UNION ALL SELECT	0	,	3000006212
UNION ALL SELECT	1142794705	,	3000004027
UNION ALL SELECT	0	,	3000000831
UNION ALL SELECT	0	,	3000074838
UNION ALL SELECT	0	,	3000076418
UNION ALL SELECT	0	,	3000016181
UNION ALL SELECT	0	,	3000007559
UNION ALL SELECT	0	,	3000007280
UNION ALL SELECT	0	,	3000014191
UNION ALL SELECT	0	,	3000078603
UNION ALL SELECT	0	,	3000078618
UNION ALL SELECT	0	,	3000082048
UNION ALL SELECT	0	,	3000007481
UNION ALL SELECT	0	,	3000007484
UNION ALL SELECT	0	,	3000016052
